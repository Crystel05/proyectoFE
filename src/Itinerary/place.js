...
export default function Place({ place }){
    ...
    return(
        <Box sx={{ p: 1, border:2, borderColor:'#f4f3f7', borderRadius:'10px', boxShadow:'1px 3px 18px #a19999' }} style={{ display:'flex', flexDirection:'row', marginTop:'2vh', width:'400px'}} >
            ...
            <Box style={{ display:'flex', flexDirection:'column', marginLeft:'1vh' }}>
                <div style={{ display:'flex', flexDirection:'row'}}>
                    ...
                    <AddCircleOutlineOutlinedIcon style={{ marginTop:'1vh', marginLeft:'150px' }}/>
                </div>
