...
export default function AddEditNews({isNew, type, id}){
    ...
    {id:'imageLink', name:'Imagen', value: newData.imageLink, type: TEXT_FIELD, isRequired:true, helperText:'Link de google drive', onChange: () => handleFieldChange()}]
    const secondCol = [{id:'description', value: newData.description, name:'Detalles', type: TEXT_AREA, isRequired:true, helperText:'', onChange: () => handleFieldChange()},
                ...
                <Box className={stylesContainer.displayColumn}>
                    <div className={ stylesContainer.spaceBetween } >
                        ...
                        {!isNew && <Box clasName={stylesContainer.displayRow} sx={{ margin:'auto', marginTop:'1vh', marginLeft:'2vh', p: 1, border:2, borderColor:'#f4f3f7', borderRadius:'10px', boxShadow:'1px 3px 18px #a19999', width:'150px', height:'150px' }}>
                            <img src={newData.image.drivePath} style={{ margin:'auto', width:'150px', height:'150px' }}/>
                        </Box>}
                    </div>
                </Box>
                <Box className={stylesContainer.displayColumn}>
